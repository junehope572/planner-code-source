...
import TicTacToeWidget from './widgets/MyCustomWidget';

function App() {
 const [widgets, setWidgets] = useState([
  { id: new Date().getTime(), component: <ClockWidget />, area: 'none-widget', name: "Date and Time" },
  ...
  {id:new Date().getTime()+4,component:<TicTacToeWidget/>,area:'main-widget',name: "Location" },
 ])
